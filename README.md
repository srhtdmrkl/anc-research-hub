# ANC Analytical Research Hub

A comprehensive data science suite analyzing the Romanian National Citizenship Authority (ANC) operational dynamics, backlog trajectories, and institutional consistency.
...
- **`scripts/`**: Modular Python engine for data extraction and institutional analysis.
  - `extraction/`: Probabilistic imputation and raw data processing.
  - `analysis/`: Machine Learning models (Random Forest) and simulation engines.
...
---
*Disclaimer: This research is based on statistical analysis of publicly available data and does not represent official institutional statements.*
